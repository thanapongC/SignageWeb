...
$sqlhor3 = "SELECT * FROM tbl_template_hor_3 WHERE user_id = {$_SESSION["user_id"]} AND device_id = $device_ID ";
$queryhor3  = mysqli_query($conn, $sqlhor3);
// if($queryhor3 == true){
// $resulthor3 = mysqli_fetch_array($queryhor3);
// }

$sqlhor3_public = "SELECT * FROM tbl_template_hor_3 WHERE user_id = {$_SESSION["user_id"]} AND device_id = $device_ID AND public_status = 1";
$queryhor3_public  = mysqli_query($conn, $sqlhor3_public);
if($queryhor3_public == true){
$resulthor3_public = mysqli_fetch_array($queryhor3_public);
}else{
  $resulthor3_public = null;
}

$sqlhor3_publicforjs = "SELECT * FROM tbl_template_hor_3 WHERE user_id = {$_SESSION["user_id"]} AND device_id = '$device_ID'";
$queryhor3_publicforjs  = mysqli_query($conn, $sqlhor3_publicforjs);
...
<body class="h-100 indexbackgroundpage">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                      ...
                      <span class="name-template">
                        ...
                        <span class="text-mb-2">เเนวนอน รูปเเบบที่ 3</span>
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="container-fluid margintopdisplay">
                    <div class="row justify-content-center">
                      <div class="col-lg-4 col-md-4 col-sm-4" style="margin: 0;position: static; width: 400px; height: 350px; background-color: #24282d; border-radius: 25px 0px 0px 0px;">
                        <?php if($resulthor3_public['image_type_1'] == "image"){ $image = explode("|", $resulthor3_public['image_slide_1']); ?>
                        <img src='../<?php echo $image[1]; ?>' class='img-fluid' width='470px' height="350px" style="margin-top: 15px" />
                        <?php }else{ $e = explode("|", $resulthor3_public['image_slide_1']); foreach ($e as $key) { if($key != ''){ ?>
                        <img class='mySlides' src='../<?php echo $key;?>' class='img-fluid' width='470px' height="350px"
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4" style="margin: 0;position: static; width: 400px; height: 350px; background-color: #24282d; border-radius: 0px 25px 0px 0px;">
                        <?php if($resulthor3_public['image_type_2'] == "image"){ $image2 = explode("|", $resulthor3_public['image_slide_2']); ?>
                        <img src='../<?php echo $image2[1]; ?>' class='img-fluid' width='470px' height="350px" style="margin-top: 15px" />
                        <?php }else{ $e2 = explode("|", $resulthor3_public['image_slide_2']); foreach ($e2 as $key2) { if($key2 != ''){ ?>
                        <img class='mySlides2' src='../<? echo $key2; ?>' class='img-fluid' width='470px' height="350px"
                          style="margin-top: 15px" />
                        <?php } } } ?>
                        <script>
                          var myIndex2 = 0;
                    ...
                    <div class="row justify-content-center">
                      <div class="col-lg-8 col-md-8 col-sm-8" style="position: static; width: 800px; height: 200px; background-color: #24282d; border-radius: 0px 0px 25px 25px;">
                        <?php if($resulthor3_public['image_type_3'] == "image"){  $image3 = explode("|", $resulthor3_public['image_slide_3']); ?>
                        <img src='../<?php echo $image3[1]; ?>' class='img-fluid' width='975px' height="170px" style="margin-top: 15px" />
                        <?php }else{ $e3 = explode("|", $resulthor3_public['image_slide_3']); foreach ($e3 as $key3) { if($key3 != ''){ ?>
                        <img class='mySlides3' src='../<?php echo $key3; ?>' class='img-fluid' width='975px' height="170px"
                          style="margin-top: 15px" />
                        <?php }}} ?>
                        <script>
                          var myIndex3 = 0;
                      ...
                      <div class="col justify-content-center">
                        <nav aria-label="Page navigation example">
                          <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link" href="showhor2.php">
                            ...
                            <li class="page-item"><a class="page-link" href="showhor3.php" style="background-color: #24282d; color: white">3</a></li>
                            </li>
                            <li class="page-item"><a class="page-link" href="showhor4.php">4</a></li>
                            <li class="page-item"><a class="page-link" href="showhor5.php">5</a></li>
                            <li class="page-item"><a class="page-link" href="showhor4.php">></a></li>
                          </ul>
                        </nav>
                      </div>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-hover">
                          ...
                          <tbody class="table-body">
                            <?php $listloop = 0; 
                            if($queryhor3 == true){
                            while ($resulthor3 = mysqli_fetch_array($queryhor3, MYSQLI_ASSOC)) { 
                            ?>
                            <tr>
                              <th scope="row">
                                <?php echo $listloop; ?>
                              ...
                              <td>
                                <?php echo $resulthor3['template_name']; ?>
                              </td>
                              <td>
                                <?php echo $resulthor3['upload_on']; ?>
                              </td>
                              <td>
                                <?php if($resulthor3['public_status'] == 0){ echo "ไม่เผยเเผร่"; }else{ echo "เผยเเผร่";} ?>
                              </td>
                              <td>
                                <!-- <form action="../php/select_template/select_template_hor_3.php" method="post"> -->
                                  <input type="hidden" class="form-control" id="template_id" name="template_id" value="<?php echo $resulthor3['template_id']?>" />
                                  <input type="hidden" class="form-control" id="template_select_id" name="template_select_id"
                                    value="<?php echo $resulthor3['template_select_id']?>" />
                                  <input type="hidden" class="form-control" id="template_name" name="template_name"
                                    value="<?php echo $resulthor3['template_name']?>" />
                                  <input type="hidden" class="form-control" id="image_slide" name="image_slide" value="<?php echo $resulthor3['image_slide']?>" />
                                  <input type="hidden" class="form-control" id="video" name="video" value="<?php echo $resulthor3['video']?>" />
                                  <input type="hidden" class="form-control" id="text_content" name="text_content" value="<?php echo $resulthor3['text_content']?>" />
                                  <input type="hidden" class="form-control" id="shop_id" name="shop_id" value="<?php echo $resulthor3['shop_id']?>" />
                                  <input type="hidden" class="form-control" id="user_id" name="user_id" value="<?php echo $resulthor3['user_id']?>" />
                                  <input type="hidden" class="form-control" id="device_id" name="device_id" value="<?php echo $resulthor3['device_id']?>" />
                                  <input type="hidden" class="form-control" id="public_status" name="public_status"
                                    value="<?php echo $resulthor3['public_status']?>" />
                              ...
                              <td>
                                <form name="delete_form" action="../php/unselect_template/unselect_template_hor_3.php"
                                  method="post">
                                  <input type="hidden" class="form-control" id="template_id" name="template_id" value="<?php echo $resulthor3['template_id']?>" />
                                  <input type="hidden" class="form-control" id="device_id" name="device_id" value="<?php echo $resulthor3['device_id']?>" />
                                  <input type="hidden" class="form-control" id="public_status" name="public_status"
                                  ...
                                  <button type="submit" class="close" aria-label="Close">
                                    <?php if($resulthor3['public_status'] == 1){ echo '<i class="fas fa-ban" style="color: #5B838D; font-size: 30px"></i>'; } ?>
                                  </button>
                                </form>
                              </td>
                              <td>
                                <form name="delete_form" action="../php/delete/delete_tem_hor3.php" method="post">
                                  <input type="hidden" class="form-control" id="template_id" name="template_id" value="<?php echo $resulthor3['template_id']?>" />
                                  <input type="hidden" class="form-control" id="public_status" name="public_status"
                                    value="<?php echo $resulthor3['public_status']?>" />
                                  <button type="submit" class="close" aria-label="Close" style="padding-right: 10px">
                                    <?php if($resulthor3['public_status'] == 0){ echo '<i class="fas fa-trash-alt" style="color: #5B838D; font-size: 30px"></i>'; } ?>
                                  </button>
                                </form>
                              </td>
                            </tr>
  ...
  <script>
        $(document).ready(function (e) {
          ...
          <?php $listloopforjs = 0;  if($queryhor3_publicforjs == true){ while ($resulthor3_publicforjs = mysqli_fetch_array($queryhor3_publicforjs, MYSQLI_ASSOC)) { ?>


          $("#showtheme<?php echo $listloopforjs; ?>").click(function () {
            
            console.log('<?php echo $listloopforjs; ?>')
            var template_id = '<?php echo $resulthor3_publicforjs['template_id']; ?>'
            var template_select_id = '<?php echo $resulthor3_publicforjs['template_select_id']; ?>'
            var device_id = '<?php echo $resulthor3_publicforjs['device_id']; ?>'
          ...
          function uploadFormData(formData) {
            $.ajax({
              url: "../php/select_template/select_template_hor_3.php",
              type: "POST",
              data: formData,
              contentType: false,
              cache: false,
