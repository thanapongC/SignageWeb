...
$sqlpic3 = "SELECT * FROM tbl_image WHERE user_id = {$_SESSION["user_id"]}";
$querypic3  = mysqli_query($conn, $sqlpic3);
...
<body class="h-100 indexbackgroundpage">
    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <!-- <form action="../../php/template/insert_template_hor_3.php" method="post" enctype="multipart/form-data"> -->
          <div class="row">
              ...
              <div class="card card-small">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding-bottom: 20px">
                      <span style="font-size: 30px; color: #fff">ตั้งค่ารูปเเบบการเเสดงผลเเนวนอน รูปเเบบที่ 3</span>
                    </div>
                  </div>
                </div>
                <div class="card-header">
                  <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                    <div class="container-fluid">
                      <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-4 col-sm-4 backgroundcolorhor3img" data-toggle="modal" data-target="#picture">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 backgroundcolorhor3img2" data-toggle="modal" data-target="#picture2">

                          <div class="containerselecttheme" id="showslidelayouttwo">
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-8 col-sm-8 backgroundcolorhor3img3" data-toggle="modal" data-target="#picture3">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-12 centerlistitem">
                <button type="button" class="addvideoshowlist" data-toggle="modal" data-target="#addPic" style="height:300px; width: 300px; border-radius: 25px;">
                  <i class="fas fa-plus addmediapluslgwhitecolor"></i>
                </button>
              </div>
  ...
  <div class="modal fade bd-example-modal-lg " id="picture3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              ...
              <?php $picloop3 = 0; while ($resultpic3 = mysqli_fetch_array($querypic3, MYSQLI_ASSOC)) { 
              $imageURL3 = '../../php/pic/'.$resultpic3["user_id"].'/'.$resultpic3["file_name"];
              $imageURL2nd3 = 'php/pic/'.$resultpic3["user_id"].'/'.$resultpic3["file_name"]; ?>
              <div class="col-lg-3 col-md-3 col-sm-12 centerlistitem">
                <img id="pic3" src="<?php echo $imageURL3; ?>" class="videoshowlist" alt="<?php echo $imageURL2nd3; ?>">
              </div>
              <?php $picloop3++; };  ?>
            </div>
          </div>
        ...
        <div class="modal-footer">
          <button type="button" id="selectpicture3" class="btn btn-light" data-dismiss="modal">เลือก</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script type="text/javascript">
    $(document).ready(function (e) {
      ...
      $("img#pic3").imgCheckbox({
        onload: function () {
          // Do something fantastic!
        },
        onclick: function (el3) {
          var isChecked = el3.hasClass("imgChked"),
            imgEl3 = el3.children()[0];
          if (isChecked == true) {
            var test3 = picArray3.length + 1;
            picArray3.splice(test3, 1, imgEl3.alt);
          }
          if (isChecked == false) {
            for (i = 0; i <= picArray3.length - 1; i++) {
              if (picArray3[i] == imgEl3.alt) {
                picArray3.splice(i, 1);
              }
            }
          }
      ...
      for (var pici = 0; pici < picArray.length; pici++) {
        ...
        $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='470' height='395'/>");
      }
      ...
      for (var pici2 = 0; pici2 < picArray2.length; pici2++) {
        // themeform.append('sendpic[]', picArray[pici]);
        $("#showslidelayouttwo").append("<img class='mySlides2' src='../../" + picArray2[pici2] + "' width='470' height='395'/>");
      }
      ...
      $("#selectpicture3").click(function () {

      for (var pici3 = 0; pici3 < picArray3.length; pici3++) {
        // themeform.append('sendpic[]', picArray[pici]);
        $("#showslidelayoutthree").append("<img class='mySlides3' src='../../" + picArray3[pici3] + "' width='973' height='190'/>");
      }
      var myIndex3 = 0;
      carousel3();
      function carousel3() {
      ...
      $("#sendform").click(function () {
        ...
        for (var pici3 = 0; pici3 < picArray3.length; pici3++) {
          themeform.append('sendpic3[]', picArray3[pici3]);
        }
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_hor_3.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
