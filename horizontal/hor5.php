    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          <!-- <form action="../../php/template/insert_template_hor_5.php" method="post" enctype="multipart/form-data"> -->
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding-bottom: 20px">
                      <span style="font-size: 30px; color: #fff">ตั้งค่ารูปเเบบการเเสดงผลเเนวนอน รูปเเบบที่ 5</span>
                    </div>
                  </div>
                  </div>
                  <div class="card-header">
                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                      <div class="container-fluid">
                        <div class="row justify-content-center">
                          <div class="col-lg-6 col-md-6 col-sm-6 backgroundcolorhor5image" data-toggle="modal" data-target="#picture">
                        ...
                        <!-- picture jqury -->
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 backgroundcolorhor5image2"  data-toggle="modal" data-target="#picture2">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-6 col-md-6 col-sm-6 backgroundcolorhor5select">
                            <div class="row">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 backgroundcolorhor5time">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../php/insert_text.php" method="post">
            ...
            <input type="hidden" class="form-control" id="page_id" name="page_id" value="hor5" />
        </div>
        <div class="modal-footer">
    ...
    $(document).ready(function (e) {
      ...
      $("img#pic2").imgCheckbox({
        ...
        for (var pici = 0; pici < picArray.length; pici++) {
          ...
          $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='725' height='545'/>");
        }
        ...
        for (var pici2 = 0; pici2 < picArray2.length; pici2++) {
          // themeform.append('sendpic[]', picArray[pici]);
          $("#showslidelayouttwo").append("<img class='mySlides2' src='../../" + picArray2[pici2] + "' width='220' height='545'/>");
        }
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_hor_5.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
