    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          <!-- <form action="../../php/template/insert_template_hor_4.php" method="post" enctype="multipart/form-data"> -->
            <div class="row">
                ...
                <div class="card card-small">
                  ...
                  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding-bottom: 20px">
                      <span style="font-size: 30px; color: #fff">ตั้งค่ารูปเเบบการเเสดงผลเเนวนอน รูปเเบบที่ 4</span>
                    </div>
                  </div>
                  </div>
                  <div class="card-header">
                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                      <div class="container-fluid">
                        <div class="row justify-content-center">
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacelefttop">
                          </div>
                          <div class="col-lg-5 col-md-5 col-sm-5 backgroundcolorhor4spacecentertop">
                            <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4" style="margin-top: 10px; margin-bottom: 10px;  color: white; text-align: center">
                              ...
                              <div class="col-lg-8 col-md-8 col-sm-8">
                                <select class="form-control" name="sendtext" id="sendtext" style="margin-top: 10px; margin-bottom: 10px; height: 45px" required>
                                  <!-- <option></option> -->
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacecentertoptime">
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacerighttop">
                          </div>
                        </div>
                        <div class="row justify-content-center">
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacelefmiddle">
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-6 backgroundcolorhor4spacecentercenter" data-toggle="modal" data-target="#video">

                          <div class="containerselectthemevideo" id="showslidelayouttwo" style="padding-top: 10px">
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacerightcenter">
                          </div>
                        </div>
                        <div class="row justify-content-center">
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacelefbottom">
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-6 backgroundcolorhor4spacecenterbottom" data-toggle="modal" data-target="#picture">
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorhor4spacerightbottom">
                          </div>
                        </div>
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-12 centerlistitem">
                <!-- <input type="checkbox" name="sendpic[]" id="picvalue" value="<?php echo $imageURL2nd; ?>">  -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../php/insert_text.php" method="post">
            ...
            <input type="hidden" id="page_id" name="page_id" value="hor4" />
        </div>
        <div class="modal-footer">
  ...
  <script type="text/javascript">
    $(document).ready(function (e) {
      ...
      for (var pici = 0; pici < picArray.length; pici++) {
        ...
        $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='720' height='98'/>");
      }
      ...
      console.log(sendvideo)
        ...
        $("#showslidelayouttwo").append("<video src='../../"+sendvideo+"' width='90%' height='100%'> </video>");
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_hor_4.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
