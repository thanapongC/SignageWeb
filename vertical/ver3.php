...
<body class="h-100 indexbackgroundpage">
    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          <!-- <form action="../../php/template/insert_template_ver_3.php" method="post" enctype="multipart/form-data"> -->
            <div class="row">
                ...
                <div class="card card-small">
                  ...
                  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding-bottom: 20px">
                      <span style="font-size: 30px; color: #fff">ตั้งค่ารูปเเบบการเเสดงผลเเนวตั้ง  รูปเเบบที่ 3</span>
                    </div>
                  </div>
                  </div>
                  <div class="card-header">
                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                      <div class="container-fluid">
                        <div class="row justify-content-center">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 backgroundcolorver3pic" data-toggle="modal" data-target="#picture">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 backgroundcolorver3pic2" data-toggle="modal" data-target="#picture2">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 backgroundcolorver3pic3" data-toggle="modal" data-target="#picture3">
  ...
  <div class="modal fade bd-example-modal-lg " id="picture3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 90%; z-index: 100;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title whitetext" id="exampleModalLongTitle">รูปภาพทั้งหมด</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
  ...
  <script type="text/javascript">
    ...
    for (var pici = 0; pici < picArray.length; pici++) {
      ...
      $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='470' height='285'/>");
    }
    ...
    var myIndex = 0;
      ...
      function carousel() {
        ...
        for (var pici2 = 0; pici2 < picArray2.length; pici2++) {
          // themeform.append('sendpic[]', picArray[pici]);
          $("#showslidelayouttwo").append("<img class='mySlides2' src='../../" + picArray2[pici2] + "' width='470' height='285'/>");
        }
        ...
        for (var pici3 = 0; pici3 < picArray3.length; pici3++) {
          // themeform.append('sendpic[]', picArray[pici]);
          $("#showslidelayoutthree").append("<img class='mySlides3' src='../../" + picArray3[pici3] + "' width='470' height='285'/>");
        }
        var myIndex3 = 0;
        carousel3();
        function carousel3() {
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_ver_3.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
