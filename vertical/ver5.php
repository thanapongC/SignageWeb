...
<body class="h-100 indexbackgroundpage">
    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          <!-- <form action="../../php/template/insert_template_ver_5.php" method="post" enctype="multipart/form-data"> -->
            <div class="row">
                ...
                <div class="card card-small">
                  ...
                  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding-bottom: 20px">
                      <span style="font-size: 30px; color: #fff">ตั้งค่ารูปเเบบการเเสดงผลเเนวตั้ง รูปเเบบที่ 5</span>
                    </div>
                  </div>
                  </div>
                  <div class="card-header">
                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                      <div class="container-fluid">
                        <div class="row justify-content-center">
                          <div class="col-lg-4 col-md-4 col-sm-4 backgroundcolorver5text">
                            <div class="row">
                              <div class="col-lg-12 col-md-12 col-sm-12" style=" text-align: center">
                                <select class="form-control" name="sendtext" id="sendtext" style="margin-top: 10px; margin-bottom: 5px" required>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-4 col-md-4 col-sm-4 backgroundcolorver5video" data-toggle="modal" data-target="#video">

                          <div class="containerselectthemevideo" id="showslidelayouttwo" style="padding-top: 8px">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-4 col-md-4 col-sm-4 backgroundcolorver5image" data-toggle="modal" data-target="#picture">
  ...
  <div class="modal fade bd-example-modal-lg " id="picture" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 90%; z-index: 100;">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="selectpicture" class="btn btn-light" data-dismiss="modal">บันทึก</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade bd-example-modal-lg " id="video" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-12" style="margin-top: 10px; margin-bottom: 10px; text-align: center; ">
                <video src="<?php echo $videoURL; ?>" style="height:300px; width: 400px; border-radius: 25px;"></video>
                <div class="row">
                  <div class="col-12" style="margin-bottom: 10px">
                    <input type="radio" name="sendvideo" id="videovalue" value="<?php echo $videoURL2nd ?>"> 
                  </div>
                </div>
              </div>
              <?php $videoloop++; }; ?>
        ...
        <div class="modal-footer">
          <button type="button" id="selectvideo" class="btn btn-light" data-dismiss="modal">บันทึก</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../php/insert_text.php" method="post">
            ...
            <input type="hidden" class="form-control" id="page_id" name="page_id" value="ver5" />
        </div>
        <div class="modal-footer">
  ...
  <script type="text/javascript">
    $(document).ready(function (e) {
      ...
      for (var pici = 0; pici < picArray.length; pici++) {
        ...
        $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='475' height='445'/> ");
      }
...
var myIndex = 0;
  ...
  function carousel() {
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_ver_5.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
