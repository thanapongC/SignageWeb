    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          <!-- <form action="../../php/template/insert_template_ver_4.php" method="post" enctype="multipart/form-data"> -->
            <div class="row">
                ...
                <div class="card card-small">
                  ...
                  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding-bottom: 20px">
                      <span style="font-size: 30px; color: #fff">ตั้งค่ารูปเเบบการเเสดงผลเเนวตั้ง รูปเเบบที่ 4</span>
                    </div>
                  </div>
                  </div>
                  <div class="card-header">
                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                      <div class="container-fluid">
                        <div class="row justify-content-center">
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 backgroundcolorver4pic" data-toggle="modal" data-target="#picture">
...
for (var pici = 0; pici < picArray.length; pici++) {
  ...
  $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='470' height='895'/>");
}
...
var myIndex = 0;
  ...
  function carousel() {
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_ver_4.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
