    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          <!-- <form action="../../php/template/insert_template_ver_1.php" method="post" enctype="multipart/form-data"> -->
            <div class="row">
                    ...
                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                      <div class="container-fluid">
                        <div class="row justify-content-center">
                          <div class="col-lg-4 col-md-4 col-sm-4 backgroundcolorver1timage" data-toggle="modal" data-target="#picture">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3 col-md-3 col-sm-3 backgroundcolorver1select">
                            <div class="row">
                            
                              <div class="col-lg-12 col-md-12 col-sm-12" style=" text-align: center; ">
                                <select class="form-control" name="sendtext" id="sendtext" style="margin-bottom: 20px; margin-top: 20px;" required>
                          ...
                          <div class="col-lg-1 col-md-1 col-sm-1 backgroundcolorver1time">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../php/insert_text.php" method="post">
            ...
            <input type="hidden" class="form-control" id="page_id" name="page_id" value="ver1" />
        </div>
        <div class="modal-footer">
...
for (var pici = 0; pici < picArray.length; pici++) {
  ...
  $("#showslidelayoutone").append("<img class='mySlides' src='../../"+picArray[pici]+"' width='470' height='735'/>");
}
...
var myIndex = 0;
  ...
  function carousel() {
      ...
      function Sendtheme(formData) {
        $.ajax({
          url: "../../php/template/insert_template_ver_1.php",
          type: "POST",
          data: formData,
          contentType: false,
          cache: false,
