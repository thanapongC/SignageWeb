                            ...
                            <div class="card card-small">
                                <div class="card-header border-bottom">
                                    <span class="name-template">
                                        ...
                                        <span class="text-mb-2">รูปเเบบเเนวนอน</span>
                                    </span>
                                </div>
                                <div class="card-header border-bottom">
                                    <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-8 col-sm-8 mb-4">
                                                <div class="card" style="width: 450px;">
                                                    <div class="container">
                                                        <img src="../images/pic/horizontal/hor1.png" width="325" class="image" />
                                                        <div class="middle">
                                                            <div class="text" data-toggle="modal" data-target="#imagemodal1"><i
                                                    ...
                                                    <div class="card-footer bg-transparent border-success">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 7px; margin-top: 5px">
                                                                <a href="horizontal/hor1.php" class="card-link"><button
                                            ...
                                            <div class="col-lg-4 col-md-8 col-sm-8 mb-4">
                                                <div class="card" style="width: 450px;">
                                                    <div class="container">
                                                        <img src="../images/pic/horizontal/hor2.png" width="325" class="image" />
                                                        <div class="middle">
                                                            <div class="text" data-toggle="modal" data-target="#imagemodal2"><i
                                                                    class="fas fa-search-plus"></i></div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-transparent border-success">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 7px; margin-top: 5px">
                                                                <a href="horizontal/hor2.php" class="card-link"><button
                                                                        type="button" class="btn btn-info">เลือกรูปเเบบนี้</button>
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-4 col-md-8 col-sm-8 mb-4">
                                                <div class="card" style="width: 450px;">
                                                    <div class="container">
                                                        <img src="../images/pic/horizontal/hor3.png" width="325" class="image" />
                                                        <div class="middle">
                                                            <div class="text" data-toggle="modal" data-target="#imagemodal3"><i
                                                                    class="fas fa-search-plus"></i></div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-transparent border-success">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 7px; margin-top: 5px">
                                                                <a href="horizontal/hor3.php" class="card-link"><button
                                                                        type="button" class="btn btn-info">เลือกรูปเเบบนี้</button>
                                                                </a>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-8 col-sm-8 mb-4">
                                                <div class="card" style="width: 450px;">
                                                    <div class="container">
                                                        <img src="../images/pic/horizontal/hor4.png" width="325" class="image" />
                                                        <div class="middle">
                                                            <div class="text" data-toggle="modal" data-target="#imagemodal4"><i
                                                                    class="fas fa-search-plus"></i></div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-transparent border-success">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 7px; margin-top: 5px">
                                                                <a href="horizontal/hor4.php" class="card-link"><button
                                                                        type="button" class="btn btn-info">เลือกรูปเเบบนี้</button>
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-4 col-md-8 col-sm-8 mb-4">
                                                <div class="card" style="width: 450px;">
                                                    <div class="container">
                                                        <img src="../images/pic/horizontal/hor5.png" width="325" class="image" />
                                                        <div class="middle">
                                                            <div class="text" data-toggle="modal" data-target="#imagemodal5"><i
                                                                    class="fas fa-search-plus"></i></div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-transparent border-success">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 7px; margin-top: 5px">
                                                                <a href="horizontal/hor5.php" class="card-link"><button
                                                                        type="button" class="btn btn-info">เลือกรูปเเบบนี้</button>
                                                                </a>
                                                            </div>
                                                        </div>
